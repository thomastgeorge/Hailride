            ...
            <div className='p-2'>
                ...
                <div className='rounded m-3' style={{ backgroundColor: "#8cd9a1" }}>
                    <div className='p-3 pb-4'>
                        {/* <div className='d-flex flex-column text-white mb-3'>
                        <p className='mb-1'>From Location</p>
                        <input type="search" className='rounded p-2' />
                    </div> */}
                        ...
                        <div className='d-flex mt-3 align-items-center justify-content-between'>
                            ...
                            <div>
                                <p className='mb-1 text-dark fw-bold'>Passengers</p>
                    ...
                    <div className='p-2 py-3 btn d-flex justify-content-center bg-black' style={{ borderTopLeftRadius: "0px", borderTopRightRadius: "0px" }}>
