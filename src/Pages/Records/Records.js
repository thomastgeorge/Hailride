    ...
    <div ref={scrollRef} className='p-3' style={{ width: "100vw", overflowY: "scroll" }}>
      {
        success ?
          ...
          :
          <>
            <b className='fs-1'>Record Work</b><br />
            {
              !valid &&
            ...
            <div className='my-3 w-100'>
              ...
              <div className='compShadow my-2 rounded-3 p-3 w-100'
                ...
                <textarea value={comments} onChange={e => setcomments(e.target.value)} className='p-1 rounded-3 w-100'
                  style={!valid && comments == "" ? { borderColor: "red", background: "#ff00001c", minHeight: "200px" } : { minHeight: "200px" }} />
              </div>
              <div className='compShadow my-2 rounded-3 p-3 w-100'
                style={{ background: "#ffff62a8" }}>
                <div className='mb-3'>
